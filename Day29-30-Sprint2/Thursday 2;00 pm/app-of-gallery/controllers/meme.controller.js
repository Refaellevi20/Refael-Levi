...
// function onFamilyFont(elFontInput) {
//     const selectedFontFamily = elFontInput.value; // Get the selected font family
//     gMeme.lines[gMeme.selectedLineIdx].fontFamily = selectedFontFamily; // Update the font family of the selected line
//     renderMeme(); // Re-render the meme
// }


function onFamilyFont(selectedFont) {
    switch (selectedFont) {
        // case 'family':
        //     gMeme.lines[gMeme.selectedLineIdx].fontFamily = elFontInput.value
        //     break
        case 'edu':
            gMeme.lines[gMeme.selectedLineIdx].fontFamily = selectedFont
            break
        case 'roboto':
            gMeme.lines[gMeme.selectedLineIdx].fontFamily = selectedFont
            break
